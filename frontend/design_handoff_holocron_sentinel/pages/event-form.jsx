  ...
  function handleSubmit(e) {
    ...
    setTimeout(() => {
      ...
      if (result.kind === 'success') {
        ...
        pushToast({
          kind: 'warning',
          title: 'Idempotência aplicada',
          desc: 'external_id já foi processado.',
        })
              ...
              <div className="form-grid">
                  ...
                  <div className="alert alert-warning">
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div className="alert-desc">
                        Um evento com{' '}
                        <code style={{ fontFamily: 'var(--font-mono)', fontWeight: 600 }}>
                          external_id={lastResult.external_id}
                        </code>{' '}
                        já foi processado em {formatTime(lastResult.first_seen_at)}. Retornando o
                        registro existente{' '}
                        <code style={{ fontFamily: 'var(--font-mono)', fontWeight: 600 }}>
                          {lastResult.event_id}
                        </code>{' '}
                ...
                <div className="field">
                  <label className="label">
                    Entidade <span className="req">*</span>
                  </label>
                  <select
                  ...
                  {errors.entity && (
                    <div className="field-error">
                      <Icon name="alert" size={12} /> {errors.entity}
                    </div>
                  )}
                  {entitySuspended && !errors.entity && (
                    <div className="field-error">
                      <Icon name="alert" size={12} /> Esta entidade está suspensa — eventos serão
                      rejeitados.
                    </div>
                  )}
                ...
                <div className="field">
                  <label className="label">
                    ...
                    <span
                      ...
                      data-tip="Chave de idempotência. Não pode ser reprocessada."
                      style={{ marginLeft: 4, color: 'var(--text-faint)' }}
                    >
                  ...
                  {errors.external ? (
                    <div className="field-error">
                      <Icon name="alert" size={12} /> {errors.external}
                    </div>
                  ) : (
                    <div className="hint">
                ...
                <div className="field">
                  <label className="label">
                    Tipo do evento <span className="req">*</span>
                  </label>
                ...
                <div className="field">
                  ...
                  {errors.payload && (
                    <div className="field-error">
                      <Icon name="alert" size={12} /> {errors.payload}
                    </div>
                  )}
                </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  {recentSubmissions.slice(0, 6).map((s, i) => (
                    ...
                    >
                      ...
                      <div style={{ color: 'var(--text-muted)', fontSize: 12 }}>
                        <code style={{ fontFamily: 'var(--font-mono)' }}>{s.externalId}</code> →{' '}
                        {s.entityName}
                      </div>
                    </div>
                  ))}
            ...
            <div className="card">
              ...
              >
                ...
                <p style={{ margin: '0 0 10px' }}>
                  Eventos do tipo <b style={{ color: 'var(--critical)' }}>critical</b> incrementam o
                  contador atomicamente. Ao atingir o limite (10), a entidade é suspensa na mesma
                  transação.
                </p>
                <p style={{ margin: 0 }}>
