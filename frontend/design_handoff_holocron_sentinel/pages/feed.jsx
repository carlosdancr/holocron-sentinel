      ...
      <div className="page-body">
        <div className="card">
          <div className="feed-controls">
            ...
            <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 12, color: "var(--text-muted)", fontSize: 12, fontFamily: "var(--font-mono)" }}>
          ...
          {filtered.length === 0 ? (
            <EmptyState
              ...
              action={paused && <button className="btn btn-ghost btn-sm" onClick={onTogglePause}><Icon name="play" size={12} /> Retomar stream</button>}
            />
          ) : (
                    ...
                    <div className="feed-body">
                      <div className="feed-title">
                        ...
                        <span style={{ color: "var(--text-faint)", fontWeight: 400, marginLeft: 8, fontSize: 12 }}>
                          em <a
                            href="#"
                            onClick={(e) => { e.preventDefault(); onOpenEntity(ev.entity_id); }}
                      ...
                      <div className="feed-meta">
                        ...
                        <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--text-faint)" }}>{ev.id}</span>
                      </div>
                    </div>
                    <button
          ...
          <div className="scrim">
            Buffer limitado a 100 eventos · auto-scroll {paused ? "pausado" : "ativo"} · reconexão automática habilitada
          </div>
        </div>
      </div>
    </div>
