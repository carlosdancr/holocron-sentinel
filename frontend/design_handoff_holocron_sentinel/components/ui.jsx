...
const Icon = ({ name, size = 16, stroke = 1.6 }) => {
  ...
  switch (name) {
    ...
    case 'feed':
      return (
        <svg {...props}>
          ...
          <circle cx="5" cy="26" r="1.5" fill="currentColor" />
        </svg>
      )
    case 'form':
      return (
    ...
    case 'ship':
      return (
        <svg {...props}>
          <path d="M12 2 4 14l8 4 8-4-8-12z" />
  ...
  return (
    <span className="meter">
      ...
      <span className="meter-val">
        {count}
        <span style={{ opacity: 0.4 }}>/{limit}</span>
      </span>
    </span>
  )
}
...
const JsonView = ({ data }) => (
  <pre className="json-block" dangerouslySetInnerHTML={{ __html: highlightJson(data) }} />
)
